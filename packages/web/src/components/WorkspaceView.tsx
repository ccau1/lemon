...
export default function WorkspaceView({ workspaceId, layer = 'page' }: WorkspaceViewProps) {
  ...
  const configOverlayZ = layer === 'modal' ? 'z-[70]' : 'z-50'
  ...
  return (
    <>
      ...
      {showConfigModal && globalConfig && rawConfig && (
        <div
          className={`fixed inset-0 ${configOverlayZ} flex items-center justify-center p-4`}
